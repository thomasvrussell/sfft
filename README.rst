...
- PyCUDA backend: The core functions of sfft are written in CUDA, PyCUDA and Scikit-Cuda.
- CuPy backend: The core functions of sfft are written in CUDA and CuPy.
